...
describe("processQueueTick", () => {
  beforeEach(async () => {
    ...
    mockPrisma.artist.findMany.mockResolvedValue([
      { id: "artist-embedded", name: "Embedded Artist" },
    ]);
        ...
        [
          {
            ...
            track: {
              ...
              serviceUrl: "https://youtube.com/watch?v=1",
            },
          },
        ],
        [
          {
            ...
            track: {
              id: "track-2",
              service: { name: "youtube" },
              serviceUrl: "https://youtube.com/watch?v=2",
            },
          },
        ],
      ];
  ...
  describe("successful job processing", () => {
    it("processes pending jobs: download → upload → complete", async () => {
      ...
      expect(mockCheckPlaylistArchiveReady).toHaveBeenCalledWith("track-1", process.env.SITE_URL);
    });
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-keep",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=keep",
          },
        },
      ]);
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-persist-ok",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=ok",
          },
        },
      ]);
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-2",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=xyz",
          },
        },
      ]);
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-3",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=net",
          },
        },
      ]);
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-4",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=max",
          },
        },
      ]);
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-auth",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=403",
          },
        },
      ]);
      mockPrisma.archiveJob.findUnique.mockResolvedValue({ retryCount: 0, errorHistory: "[]" });
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-cookie",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=cookie",
          },
        },
      ]);
      mockPrisma.archiveJob.findUnique.mockResolvedValue({ retryCount: 0, errorHistory: "[]" });
      ...
      const cookieJobs = [
        ...
        },
        {
          ...
          track: {
            id: "track-3",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=3",
          },
        },
      ];
      ...
      const jobs = [
        {
          ...
          track: {
            id: "track-1",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=fail1",
          },
        },
        {
          id: "job-fail-2",
          track: {
            id: "track-2",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=fail2",
          },
        },
        {
          id: "job-success",
        ...
        },
        {
          ...
          track: {
            id: "track-4",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=fail3",
          },
        },
      ];
      ...
      mockPendingArchiveJobs([
        {
          ...
          track: {
            id: "track-geo",
            service: { name: "youtube" },
            serviceUrl: "https://youtube.com/watch?v=geo",
          },
        },
      ]);
      mockPrisma.archiveJob.findUnique.mockResolvedValue({ retryCount: 0, errorHistory: "[]" });
