        ...
        <div>
          <div className="mx-auto w-full max-w-md px-8">
            ...
            <div className="flex flex-col gap-5">
              <PasskeyLogin redirectTo={redirectTo} remember={fields.remember.value === "on"} />
            </div>
...
function PasskeyLogin({ redirectTo, remember }: { redirectTo: string | null; remember: boolean }) {
...
export const meta: Route.MetaFunction = () => {
  return [{ title: "Login to Music Library" }];
};
